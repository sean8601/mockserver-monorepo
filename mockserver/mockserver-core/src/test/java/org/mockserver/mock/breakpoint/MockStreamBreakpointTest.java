...
public class MockStreamBreakpointTest {
    ...
    public void shouldHandleMixedStreamTypesIndependently() throws Exception {
        ...
        // Can resolve gRPC without affecting WebSocket/SSE
    ...
    public void shouldDistinguishStreamIdFormats() throws Exception {
        ...
        assertThat(registry.activeStreamIds(), hasItems("corr-1-stream", "corr-1-grpc-stream", "corr-1-ws-stream"));

        // Evicting one stream does not affect others
    ...
    public void shouldEnforceCapAcrossAllStreamTypes() {
        ...
        // Fourth frame should be rejected (cap reached)
